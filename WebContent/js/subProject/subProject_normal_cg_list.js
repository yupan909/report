...
$(function(){
	...
	$("#newBtn").click(function(){
		window.open("subProject/subProject_FORM.html");
	});
	load(curr);
...
function load(cnt){
	...
	$.ajax({
        url: "../getSubProjectList.do",
        dataType: "json",
        type: "POST",
        data: {"cnt":cnt,"ktmc":ktmc,"ztc":ztc,"status":"0"},
...
function view(id){
	if(id==""||id=="undefined"){
		...
		window.open("subProject/subProject_FORM.html?id="+id);
	}
}
